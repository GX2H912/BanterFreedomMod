...
public class Command_sys extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (sender.getName().equals("__Crafted") && !TFM_Util.EXECUTIVES.contains(sender.getName()) && !TFM_Util.SYS.contains(sender.getName()) && !TFM_Util.CRAFTEDRANK.contains(sender.getName()) && !TFM_Util.COOWNER.contains(sender.getName()) && !TFM_ConfigEntry.SERVER_OWNERS.getList().contains(sender.getName()) && !sender.getName().equals("MysteriAce"))
        {
            sender.sendMessage(TFM_Command.MSG_NO_PERMS);
            Bukkit.broadcastMessage(ChatColor.RED + "WARNING: " + sender.getName() + " has attempted to use a system admin only command. System administration team has been alerted.");
            smite(sender_p);
        ...
        if (mode.equals("add"))
        {
            ...
            TFM_Util.adminAction(sender.getName(), "Adding " + args[1] + " to the Super Admin list", true);
        ...
        if (mode.equals("del"))
        {
            ...
            TFM_Util.adminAction(sender.getName(), "Removing " + args[1] + " from the Super Admin list", true);
        ...
        {
            if (!TFM_Util.CRAFTEDRANK.contains(sender.getName()) && !TFM_ConfigEntry.SERVER_OWNERS.getList().contains(sender.getName()))
            {
                sender.sendMessage(TFM_Command.MSG_NO_PERMS);
                return true;
            }
