...
@CommandParameters(description = "For the abusive admins!", usage = "/<command> <playername>")
public class Command_doom extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        if (senderIsConsole)
        {
            TFM_Log.info("No abuse you stupid fucking prick!");
            return true;
        }
        ...
        {
            TFM_Util.adminAction(sender.getName(), "Removing " + player.getName() + " from the Super Admin list.", true);
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.RED + "Fuck Off Cunt u belong in hell!");
            }
