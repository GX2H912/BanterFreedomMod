...
public class Command_admininfo extends TFM_Command
{
    ...
    {
        TFM_Util.playerMsg(sender_p, "So you wish to apply for Super Admin?", ChatColor.BLUE);
        TFM_Util.playerMsg(sender_p, "Go to our forums at http://banterfreedom.boards.net/", ChatColor.GREEN);
