...
@CommandParameters(description = "Send a chat message as someone else, this command is just pure evil (Set to seniors only)", usage = "/<command> <fromname> <message>", aliases = "fchat")
public class Command_fc extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        try
        {
            playerMsg(ChatColor.RED + "Sending message as " + player.getName() + ": " + outCommand);
