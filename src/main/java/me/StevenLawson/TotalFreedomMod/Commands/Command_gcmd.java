...
public class Command_gcmd extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            sender.sendMessage(ChatColor.YELLOW + "Freedom >" + ChatColor.RED + "You can not send a command as an high ranking admin.");
            return true;
        }
        ...
        {
            playerMsg(ChatColor.RED + "Error sending command: " + ex.getMessage());
        }
