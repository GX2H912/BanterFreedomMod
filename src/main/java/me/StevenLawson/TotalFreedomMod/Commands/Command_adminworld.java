        ...
        try
        {
            switch (commandMode)
            {
                case TELEPORT:
                {
                    ...
                    {
                        playerMsg(ChatColor.RED + "Welcome to BanterFreedom Remastered's MainWorld");
                    ...
                    else
                    {
                        ...
                        {
                            playerMsg(ChatColor.RED + "Welcome to BanterFreedom Remastered's AdminWorld");
                            TFM_AdminWorld.getInstance().sendToWorld(sender_p);
                        }
                        else
                        {
                            playerMsg(ChatColor.YELLOW + "Freedom >" + ChatColor.RED + "OPs Can't go to the AdminWorld");
                        }
                    }
