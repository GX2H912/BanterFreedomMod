...
{
    public static final String MSG_NO_PERMS = ChatColor.YELLOW + "Freedom > " + ChatColor.RED + "You have no permisions to use this command!";
    public static final String YOU_ARE_OP = ChatColor.YELLOW + "Freedom > " + ChatColor.RED + "You are now OP!";
    public static final String YOU_ARE_NOT_OP = ChatColor.YELLOW + "Freedom > " + ChatColor.RED + "You are no longer OP!";
    public static final String NOT_FROM_CONSOLE = ChatColor.RED + "This command may not be used from the console.";
    public static final String PLAYER_NOT_FOUND = ChatColor.GRAY + "Player is not online or has never joined!";
